...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const DEFAULT_SITE_IMAGES = [
    ...
    { key: 'best_seller_1', label: 'Best Seller 1', location: 'Homepage → Best Sellers Section', path: '/store/images/optimized/best_sellers.webp', price: '$650', name: 'Minimal Leather Tote' },
    { key: 'best_seller_2', label: 'Best Seller 2', location: 'Homepage → Best Sellers Section', path: '/store/images/optimized/best_sellers.webp', price: '$480', name: 'Cashmere Turtleneck' },
    { key: 'best_seller_3', label: 'Best Seller 3', location: 'Homepage → Best Sellers Section', path: '/store/images/optimized/best_sellers.webp', price: '$850', name: 'Tailored Blazer' },
    { key: 'best_seller_4', label: 'Best Seller 4', location: 'Homepage → Best Sellers Section', path: '/store/images/optimized/best_sellers.webp', price: '$1200', name: 'Silk Evening Dress' },
    { key: 'instagram_grid_1', label: 'Instagram Gallery 1', location: 'Homepage → Instagram Section', path: '/store/images/optimized/instagram_grid.webp', price: 'Social', name: 'IG Feed 1' },
    { key: 'instagram_grid_2', label: 'Instagram Gallery 2', location: 'Homepage → Instagram Section', path: '/store/images/optimized/instagram_grid.webp', price: 'Social', name: 'IG Feed 2' },
    { key: 'instagram_grid_3', label: 'Instagram Gallery 3', location: 'Homepage → Instagram Section', path: '/store/images/optimized/instagram_grid.webp', price: 'Social', name: 'IG Feed 3' },
