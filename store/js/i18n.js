...
var VINATO_TRANSLATIONS = {
  en: {
    ...
    'nav.sale': 'Sale',  'nav.men.jackets':      'Jackets',
  'nav.men.sweaters':     'Sweaters',
  'nav.men.shirts':       'Shirts',
  'nav.men.pants':        'Pants',
  'nav.men.suits':        'Suits',
  'nav.men.accessories':  'Accessories',
  'nav.men.pajamas':      'Pajamas',
  'nav.men.underwear':    'Underwear',
  'nav.men.boots':        'Boots',
  'nav.women.jackets':    'Jackets',
  'nav.women.sweaters':   'Sweaters',
  'nav.women.shirts':     'Shirts',
  'nav.women.pants':      'Pants',
  'nav.women.dresses':    'Dresses',
  'nav.women.accessories':'Accessories',
  'nav.women.pajamas':    'Pajamas',
  'nav.women.underwear':  'Underwear',
  ...
  ar: {
    ...
    'nav.sale': 'تخفيضات',  'nav.men.jackets':      'جاكيتات',
  'nav.men.sweaters':     'كنزات',
  'nav.men.shirts':       'قمصان',
  'nav.men.pants':        'بناطيل',
  'nav.men.suits':        'بدلات',
  'nav.men.accessories':  'إكسسوارات',
  'nav.men.pajamas':      'بيجامات',
  'nav.men.underwear':    'ملابس داخلية',
  'nav.men.boots':        'أحذية',
  'nav.women.jackets':    'جاكيتات',
  'nav.women.sweaters':   'كنزات',
  'nav.women.shirts':     'قمصان',
  'nav.women.pants':      'بناطيل',
  'nav.women.dresses':    'فساتين',
  'nav.women.accessories':'إكسسوارات',
  'nav.women.pajamas':    'بيجامات',
  'nav.women.underwear':  'ملابس داخلية',
